    ...
    <main class="flex-1 p-10">
      ...
      <div class="grid grid-cols-4 gap-6 mb-10">
        <div class="bg-white p-6 rounded-xl shadow">
          ...
          <p class="text-green-600 text-sm mt-1">↑ 5% from yesterday</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow">
          ...
          <h3 class="text-3xl font-bold mt-2">1,058</h3>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow">
          ...
          <h3 class="text-3xl font-bold mt-2">172</h3>
        </div>
      ...
      <div class="bg-white p-6 rounded-xl shadow mb-6">
        <div class="flex gap-6 items-center">
          <div>
            ...
            <input type="date" class="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500" value="2024-01-15">
          </div>
          <div>
          ...
          <button class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 mt-6">
            Apply Filters
          </button>
        </div>
      </div>
      ...
      <div class="bg-white p-6 rounded-xl shadow">
        <div class="flex justify-between items-center mb-6">
          <h3 class="text-xl font-semibold">Today's Attendance (Jan 15, 2024)</h3>
        ...
        <table class="w-full text-left">
          ...
          <tbody class="text-gray-600">
            <tr class="border-b">
              <td class="py-3">STU001</td>
              <td class="py-3">Mark Smith</td>
              <td>Computer Science</td>
              <td>2nd year</td>
              <td><span class="bg-green-100 text-green-700 px-3 py-1 rounded-full">Present</span></td>
              <td>08:45 AM</td>
            ...
            <tr class="border-b">
              <td class="py-3">STU002</td>
              <td class="py-3">Alice Johnson</td>
              <td>Information Technology</td>
              <td>1st year</td>
              <td><span class="bg-red-100 text-red-700 px-3 py-1 rounded-full">Absent</span></td>
              <td>-</td>
              <td class="text-center">
                <button class="mx-2 text-blue-600 hover:text-blue-800">👁️</button>
                <button class="mx-2 text-yellow-600 hover:text-yellow-800">✏️</button>
            ...
            <tr class="border-b">
              <td class="py-3">STU003</td>
              <td class="py-3">Emma Brown</td>
              <td>Physics</td>
              <td>1st year</td>
              <td><span class="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full">Late</span></td>
              <td>09:15 AM</td>
              <td class="text-center">
                <button class="mx-2 text-blue-600 hover:text-blue-800">👁️</button>
                <button class="mx-2 text-yellow-600 hover:text-yellow-800">✏️</button>
            ...
            <tr>
              <td class="py-3">STU005</td>
              <td class="py-3">Sarah Miller</td>
              <td>Chemistry</td>
              <td>4th year</td>
              <td><span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full">Excused</span></td>
              <td>-</td>
              <td class="text-center">
                <button class="mx-2 text-blue-600 hover:text-blue-800">👁️</button>
                <button class="mx-2 text-yellow-600 hover:text-yellow-800">✏️</button>
        ...
        <div class="flex justify-between items-center mt-6">
          <p class="text-gray-500">Showing 1-5 of 245 attendance records</p>
